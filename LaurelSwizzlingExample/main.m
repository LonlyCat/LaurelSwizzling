...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        [LaurelSwizzling overrideImplementation: ^id _Nonnull(__unsafe_unretained Class  _Nonnull cls, SEL  _Nonnull originCMD, IMPProvider  _Nonnull originalIMPProvider) {
        ...
        [LaurelSwizzling extendVoidImplementation: ^(__kindof Student *student) {
